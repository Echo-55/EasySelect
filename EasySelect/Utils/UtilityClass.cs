...
namespace EasySelect.Utils
{
    public static class UtilityClass
    {
        ...
        public static void ShowToast(string message, ToastPosition toastPosition)
        {
            Toast.Present(message, toastPosition);
        }
        ...
        private static void SelectLoco(int index, bool alsoJumpTo)
        {
            ...
            {
                ESLogger.LogError("No locomotives found.");
                return;
            }
        ...
        public static void SelectPreviousLoco(bool alsoJumpTo = false)
        {
            ...
            var trainController = TrainController.Shared;
            BaseLocomotive currentLoco = trainController?.SelectedLocomotive ?? ownedLocos[0];
            int prevIndex = (ownedLocos.IndexOf(currentLoco) - 1 + ownedLocos.Count) % ownedLocos.Count;
        ...
        public static List<BaseLocomotive> GetOwnedLocos()
        {
            ...
            var ownedLocos = new List<BaseLocomotive>();
        ...
        {
            var enumerateCoupled = locomotive.EnumerateCoupled();
        ...
        /// <returns></returns>
        public static bool TryGetDestinationInfo(Car car, out Vector3 destinationPosition)
        {
            ...
            if (!opsController.TryGetDestinationInfo(car, out var destinationName, out var isAtDestination,
                    out destinationPosition, out OpsCarPosition destination)) return false;
